...
function generateCarPages(distPath) {
  ...
  vehicles.forEach((vehicle, vehicleIndex) => {
   ...
   <td class="p-3 border-b">
     ...
     // Build related links for same brand
     ...
     const relatedLinks = relatedVehicles.map(rel => 
       `<a href="/cars/${rel.slug}/" class="block p-3 border border-gray-200 rounded hover:border-blue-400 hover:bg-blue-50 transition">
